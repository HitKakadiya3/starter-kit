...
export const ESTJ: PremiumTypeData = {
  ...
  famousQuote: { text: "The secret of getting ahead is getting started.", person: "Often attributed to leaders of the ESTJ mold" },
  introduction: [
  ...
  cognitiveFunctions: {
    dominant: { name: "Extraverted Thinking", abbr: "Te", description: "Your primary mode. You channel observations into efficient, logical action in the outer world. You organize people and systems to achieve measurable results, and this is what others see most clearly when they watch you work." },
    auxiliary: { name: "Introverted Sensing", abbr: "Si", description: "Your support system. You experience the world through a rich internal library of past impressions. You trust what has been proven to work and bring unmatched attention to detail, drawing on experience to inform decisions." },
    tertiary: { name: "Extraverted Intuition", abbr: "Ne", description: "Developing with age. Abstract possibilities and creative brainstorming become more interesting and accessible as you mature. This function helps you consider new ideas rather than only proven approaches." },
    inferior: { name: "Introverted Feeling", abbr: "Fi", description: "Your hidden edge and stress trigger. Beneath your decisive exterior is a personal value system that rarely surfaces. Under stress, you may become hypersensitive to criticism, feel unappreciated, or experience unexpected emotional outbursts." },
  },
  strengths: [
  ...
  friendships: {
    ...
    positives: ["The friend who actually follows through — calls when they say they will, shows up when you need them", "The organiser — turns vague plans into actual events with times, places, and logistics sorted", "The honest advisor — gives you the real answer, not the one designed to make you feel better"],
    watchOuts: ["Can be judgemental of friends who don't meet their reliability standards", "May struggle to just listen without jumping to solutions or advice"],
  },
  career: {
    ...
    bestCareers: [
      ...
      { label: "Financial Officer", icon: "shield" },
      { label: "Civil Engineer", icon: "building" },
      { label: "School Principal", icon: "graduation-cap" },
      { label: "Supply Chain Manager", icon: "briefcase" },
    ],
    leadershipStyle: ["Takes charge quickly and decisively — rarely waits to be asked", "Sets clear expectations and holds everyone (including themselves) accountable", "Leads by example: works hard, follows through, and expects the same", "Focuses on results and efficiency over process exploration"],
    asTeammate: ["The person who keeps the team on track and on deadline", "Volunteers for the organisational tasks others avoid", "Speaks up when they see a flaw or inefficiency — even when it's uncomfortable"],
    cautionCareers: ["Creative arts (high ambiguity, few measurable outcomes)", "Social work (emotional demands may conflict with logical decision-making style)"],
  },
  growthRoadmap: [
  ...
  typeComparisons: [
    {
      ...
      keyDifferences: ["ESTJs are energised by leading and engaging others; ISTJs prefer working independently", "ESTJs are more vocal about standards and quicker to confront; ISTJs process internally first", "ESTJs thrive on managing teams; ISTJs prefer mastering their own domain deeply"],
    ...
    },
    {
      ...
      keyDifferences: ["ESTJs focus on the present and proven systems; ENTJs think more strategically about the long-term future", "ESTJs follow established procedures; ENTJs redesign systems from scratch when needed", "ESTJs are more traditional; ENTJs are more visionary and comfortable with radical change"],
      youMightBeThis: "If you find yourself constantly envisioning entirely new systems rather than improving existing ones",
    },
  ],
  affirmations: ["I bring order, reliability, and integrity to everything I do.", "My directness is a gift — it gives others the clarity they need to succeed.", "I can honour my high standards and still make space for others to grow at their own pace."],
};
